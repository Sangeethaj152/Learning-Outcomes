package lockedme;
	...
	public class LockedMeMain {
	    ...
	    public static void main(String[] args)  {
	        File folder = new File("C:\\Users\\J.Sangeetha\\Desktop\\MyNewFolder");
	        folder.mkdirs();
	        try (Scanner scan = new Scanner(System.in)) {
				while(true){

				    System.out.println("**********My Application LockedMe.com**********  \n");
				        ...
				        case 2:
				            ...
				            while(temp) {
				                ...
				                switch (choice2) {
				                    ...
				                    case 3:
				                        System.out.println("Enter folder name to search");
				                    ...
				                    case 5:
				                        ...
				                        System.exit(0);
				                    default:
				                        System.out.println("Please retry, Input correct value");
